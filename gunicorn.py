...
# chdir = '/www/wwwroot/api/'  # 加载应用程序之前将chdir目录指定到指定目录

proc_name = 'api'  # 进程名

bind = '0.0.0.0:5252'  # 绑定ip和端口号
...
# accesslog = "/api/logs/api_access.log"  # 访问日志文件, "-" 表示标准输出

# errorlog = "/api/logs/api_err.log"  # 错误日志文件, "-" 表示标准输出
